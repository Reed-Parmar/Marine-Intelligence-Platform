...
import { MapPin, Sliders, Layers, Sparkles } from 'lucide-react';
...
export const MarineMapPage: React.FC = () => {
  ...
  return (
    <div className="space-y-4 animate-fade-in relative h-[calc(100vh-6.5rem)] flex flex-col">
      ...
      {/* Main Map Container */}
      <div className="flex-1 relative rounded-2xl overflow-hidden border border-marine-800 shadow-2xl">
        {isLoading ? (
          <div className="w-full h-full flex items-center justify-center bg-marine-950">
            <CardSkeleton rows={4} />
          </div>
        ) : (
          <MarineMap
